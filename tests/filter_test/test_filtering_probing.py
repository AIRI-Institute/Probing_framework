...
class TestProbingConlluFilter(unittest.TestCase):
    ...
    def test__filter_conllu(self):
        ...
        self.assertEqual(
            probing_filter._filter_conllu("SOmatchingNumber")[0], SOmatchingNumber_res
        )
        self.assertEqual(
            probing_filter._filter_conllu("ADPdistance")[0], ADPdistance_res
        )
